...
export interface WebsiteWizardProps {
  unlimited?: boolean;
  brandTitle?: string;
...
export default function WebsiteWizard({
  ...
  const [remaining, setRemaining] = useState(unlimited ? -1 : 5);
  const [limitReached, setLimitReached] = useState(false);
  const [detailsOpen, setDetailsOpen] = useState(true);
  const [generatingName, setGeneratingName] = useState(false);

  const title = editingWebsite
    ? "Edit Website"
    : brandTitle || "Web Wizard";
  ...
  return (
    <div className="max-w-6xl mx-auto animate-fade-in">
      {!unlimited && limitReached && page !== "done" && (
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex items-center gap-4">
            {unlimited ? (
              <span className="text-xs text-accent-pink bg-accent-pink/10 px-3 py-1 rounded-full font-bold">
                ∞ Unlimited
              </span>
            ) : (
      ...
      {page === "prompt" && !analyzing && (
        <div className="animate-fade-in max-w-2xl mx-auto">
          ...
          <p className="text-gray-400 mb-8 text-center">
            {brandDescription || "Tell us about your business and what you need — our AI will build your website in seconds."}
          </p>
          ...
          <div className="card space-y-5">
            ...
            <button
              ...
              disabled={!prompt.trim() || (!unlimited && limitReached)}
        ...
        <div className="animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button
              ...
              disabled={!selectedBlueprint || !form.businessName || (!unlimited && limitReached)}

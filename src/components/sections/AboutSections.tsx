  ...
  return (
    <section style={{ background: `linear-gradient(180deg, ${tone.bg} 0%, ${tone.surface} 100%)`, fontFamily: tone.bodyFont }} className="py-24 px-6 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        {aboutImage && (
          <div style={{ marginBottom: 28, overflow: "hidden", borderRadius: tone.radius, boxShadow: `0 16px 40px -8px ${tone.primary}15`, maxHeight: 360 }}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src={aboutImage} alt="" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block", maxHeight: 360 }} />
          </div>
        )}
